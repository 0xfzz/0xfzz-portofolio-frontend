    ...
    <div className="group bg-white rounded-2xl p-4 border border-border-subtle">
      ...
      <div className="px-2 space-y-4">
        <div className="space-y-2">
          <h3 className="text-2xl font-bold tracking-tight leading-tight text-foreground group-hover:text-black transition-colors">
            {title}
          </h3>
        ...
        <div className="pt-4 border-t border-border/40">
          <Link
            href={`/projects/${slug}`}
            className="inline-flex items-center gap-2 text-sm font-bold text-foreground hover:gap-3 transition-all"
          >
